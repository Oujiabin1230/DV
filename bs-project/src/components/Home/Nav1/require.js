...
export async function Nav1_SubNav1_Data(searchDate,searchCount) {
   var url = `http://127.0.0.1:8000/api/total_cases/?start_date=${searchDate}&end_date=${searchDate}&country_count=${searchCount}`
...
export async function Nav1_SubNav2_Data(searchDate,searchCount) {
   var url = `http://127.0.0.1:8000/api/total_deaths/?start_date=${searchDate}&end_date=${searchDate}&country_count=${searchCount}`
   const { data: res, status, statusText } = await axios.get(url)
   if (status !== 200) {
      ElMessage.error(statusText)
    }
...
export async function Nav1_SubNav3_Data(searchDate,searchCount) {
   var url = `http://127.0.0.1:8000/api/total_tests/?start_date=${searchDate}&end_date=${searchDate}&country_count=${searchCount}`
   const { data: res, status, statusText } = await axios.get(url)
   if (status !== 200) {
      ElMessage.error(statusText)
    }
...
export async function Nav1_SubNav5_Data(searchDate,searchCount) {
   var url = `http://127.0.0.1:8000/api/new_deaths_sum/?start_date=${searchDate[0]}&end_date=${searchDate[1]}&country_count=${searchCount}`
   const { data: res, status, statusText } = await axios.get(url)
   if (status !== 200) {
      ElMessage.error(statusText)
    }
